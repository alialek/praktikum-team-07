...
import { REQUIRED_VALUE_MESSAGE, EMAIL_VALUE_MESSAGE } from "@/сonstants/validationMessages";
      ...
      >
        <Grid item xs={3}>
          <form onSubmit={handleSubmit(onSubmit)}>
            <Card sx={{ minWidth: 552, padding: '50px 40px', borderRadius: '10px', backgroundColor: '#FAFAFA'}}>
